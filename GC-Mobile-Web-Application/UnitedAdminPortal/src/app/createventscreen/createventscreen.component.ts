...
@Component({
  selector: 'app-createventscreen',
  templateUrl: './createventscreen.component.html',
  styleUrls: ['./createventscreen.component.scss']
})
export class CreateventscreenComponent implements OnInit {
