...
class FullScreenPromo extends StatefulWidget {
  final ProfessionalUser proUser;
  FullScreenPromo({this.proUser});
  @override
  State<StatefulWidget> createState() {
    return FullScreenPromoState(proUser);
  }
}

class FullScreenPromoState extends State<FullScreenPromo> {
  ProfessionalUser proUser;
  FullScreenPromoState(this.proUser);
  ...
  SharedMethods sh= new SharedMethods();
   ...
   createMainScreenPromo() async {
     ...
     var result = await createNewMainScreenPromo("createNewFullScreenPromo", {"fullscreenpromo": newPromo.toJson()});
     if (result == 200) {
       setState(() {
                          ...
                          GestureDetector(
                            ...
                            child: ClipOval(
                              child: Container(
                                ...
                                child: Center(
                                    child:
                                    Text(secondaryPreferencesList[0], textAlign: TextAlign.center)),
                              ),
                            ),
                          ),
                          SizedBox(width: 10),
                          GestureDetector(
                            ...
                            child: ClipOval(
                              child: Container(
                                ...
                                child: Center(
                                    child:
                                    Text(secondaryPreferencesList[1], textAlign: TextAlign.center)),
                              ),
                            ),
                          ),
                          SizedBox(width: 10),
                          ...
                          GestureDetector(
                            ...
                            child: ClipOval(
                              child: Container(
                                ...
                                child: Center(
                                    child:
                                    Text(secondaryPreferencesList[2], textAlign: TextAlign.center)),
                              ),
                            ),
                          ),
                        ],
